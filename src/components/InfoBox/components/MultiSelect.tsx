...
export default function MultiSelect(props: MultiSelectProps) {
  ...
  return (
    <div className="flex flex-col relative w-96 mt-1" ref={dropdownRef}>
        ...
        <div className="mb-2">
            ...
            .join(", ")}
              ...
              <div
                  className={`border border-gray-300 p-2 w-80 rounded-md cursor-pointer bg-white ${props.disabled ? "opacity-50 cursor-not-allowed" : "hover:border-blue-500"
                      }`}
              ...
              >
                  <div className="flex flex-wrap gap-2">
                      {props.value.length > 0 ? (
                          ...
                          <span className="text-gray-500">{props.placeholder || "Select options..."}</span>
                      )}
                  </div>
              </div>
          )}
